...
export class AlertComponent implements OnInit, OnDestroy {
  ...
  @Input() position: PositiionType = PositiionType.TopRight;
  ...
  // if max items is reached the alert is queued until count of alerts decreased under maxItems
