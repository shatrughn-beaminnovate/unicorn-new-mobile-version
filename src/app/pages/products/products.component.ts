...
import { NotifyMeModalComponent } from 'src/app/core/shared/components/notify-me-modal/notify-me-modal.component';
...
export class ProductsComponent implements OnInit {
  ...
  getProductsBySlug(slug: string) {
    ...
    this.commonService.postRequestWithSlug(slug, payload).subscribe((result) => {
      this.productsHolder = result.products;
        ...
        if (this.isWishlistAdded[i]) {
          ...
          this.dataLayerService.push({
            ...
            ecommerce: {
              ...
              item_list_name: "Product Add to Wishlist",
              items: [{
                item_id: product.id,
                item_name: product.name,
                currency: 'INR',
